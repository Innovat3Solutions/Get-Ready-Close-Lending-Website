...
export default function USDALoan() {
    const { t } = useLanguage();
        ...
        <div className="antialiased font-serif bg-white">
            ...
            <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20 pb-20 text-center">
                <div className="absolute inset-0 z-0">
                    <img
                        src="/Images/freepik__middleclass-family-standing-proudly-in-front-of-a-__31263.png"
                        alt="USDA Rural Development Loans Florida"
                ...
                <div className="relative max-w-4xl mx-auto px-6 w-full z-10 flex flex-col items-center">
                    ...
                    >
                        ...
                        <h1 className="font-display text-5xl md:text-7xl text-white mb-6 leading-[1.1] tracking-tight">
                            <span dangerouslySetInnerHTML={{ __html: t('usda.hero.title1') }} />
                            <span className="text-grc-blue italic">{t('usda.hero.title2')}</span>
                        </h1>
            ...
            <section className="py-24 bg-white relative">
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
                        <div>
                            <h2 className="font-display text-4xl md:text-5xl text-corp-grey mb-8">{t('usda.feat.title')}</h2>
                            ...
                            <ul className="space-y-5 text-slate-600 font-light text-lg">
                                <li className="flex items-start gap-4 p-4 bg-slate-50 border-l-4 border-growth-green">
                                    ...
                                    <div>
                                        <span className="font-bold text-corp-grey block mb-1">{t('usda.feat.1.title')}</span>
                                        <span className="text-sm">{t('usda.feat.1.desc')}</span>
                                    </div>
                                </li>
                                <li className="flex items-start gap-4 p-4 bg-slate-50 border-l-4 border-growth-green">
                                    <span className="material-symbols-outlined text-growth-green mt-1">check_circle</span>
                                    <div>
                                        <span className="font-bold text-corp-grey block mb-1">{t('usda.feat.2.title')}</span>
                                        <span className="text-sm">{t('usda.feat.2.desc')}</span>
                                    </div>
                                </li>
                                <li className="flex items-start gap-4 p-4 bg-slate-50 border-l-4 border-growth-green">
                                    <span className="material-symbols-outlined text-growth-green mt-1">check_circle</span>
                                    <div>
                                        <span className="font-bold text-corp-grey block mb-1">{t('usda.feat.3.title')}</span>
                                        <span className="text-sm">{t('usda.feat.3.desc')}</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div className="relative">
                            ...
                            <img
                                src="/Images/freepik__aerial-drone-shot-of-luxury-south-florida-resident__31249.png"
                                alt="Aerial view of suburban community"
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 mb-24">
                        {/* CSS Graph: Target Demographic vs Income */}
                        <div className="p-10 border border-slate-100 shadow-sm bg-white">
                            <h3 className="font-display text-3xl text-corp-grey mb-2">{t('usda.graph.title')}</h3>
                            <p className="text-slate-500 text-sm font-light mb-8">{t('usda.graph.desc')}</p>

                            <div className="space-y-8">
                                {/* Eligible */}
                                <div>
                                    <div className="flex justify-between text-sm font-bold text-corp-grey mb-2">
                                        <span>{t('usda.graph.l1')}</span>
                                        <span className="text-growth-green">{t('usda.graph.l2')}</span>
                                    </div>
                                    <div className="w-full bg-slate-100 h-6 flex overflow-hidden">
                                        ...
                                        />
                                        <div className="bg-red-200 flex-1 h-full border-l-2 border-white flex items-center justify-center">
                                            <span className="text-[10px] text-red-500 font-bold uppercase">{t('usda.graph.l3')}</span>
                                        </div>
                                    </div>
                                </div>
                                {/* Large Household */}
                                <div>
                                    <div className="flex justify-between text-sm font-bold text-corp-grey mb-2">
                                        <span>{t('usda.graph.l4')}</span>
                                        <span className="text-growth-green">{t('usda.graph.l5')}</span>
                                    </div>
                                    <div className="w-full bg-slate-100 h-6 flex overflow-hidden">
                                        <motion.div
                                            initial={{ width: 0 }}
                                        ...
                                        />
                                        <div className="bg-red-200 flex-1 h-full border-l-2 border-white flex items-center justify-center">
                                            <span className="text-[8px] text-red-500 font-bold uppercase">{t('usda.graph.l6')}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col justify-center space-y-8">
                            <div className="bg-light-grey p-8 border-l-4 border-corp-grey hover:shadow-lg transition-shadow">
                                <h3 className="font-display text-2xl text-corp-grey mb-3">{t('usda.data.1.title')}</h3>
                                <p className="text-slate-500 font-light leading-relaxed">
                                    {t('usda.data.1.desc')}
                                </p>
                            </div>
                            <div className="bg-light-grey p-8 border-l-4 border-growth-green hover:shadow-lg transition-shadow">
                                <h3 className="font-display text-2xl text-corp-grey mb-3">{t('usda.data.2.title')}</h3>
                                <p className="text-slate-500 font-light leading-relaxed">
                                    {t('usda.data.2.desc')}
                                </p>
                            </div>
                    ...
                    <div className="bg-corp-grey relative overflow-hidden py-16 px-8 lg:px-16 flex flex-col items-center text-center">
                        ...
                        <h2 className="font-display text-3xl md:text-5xl text-white mb-6 relative z-10">{t('usda.cta.title')}</h2>
                        <p className="text-slate-300 max-w-2xl mx-auto font-light text-lg mb-10 relative z-10">
                            {t('usda.cta.desc')}
                        </p>

                        <div className="flex flex-col sm:flex-row gap-6 justify-center relative z-10">
                            <Link to="/contact?type=usda" className="group relative inline-flex items-center justify-center bg-growth-green text-white px-10 py-5 text-xs font-bold uppercase tracking-[0.2em] overflow-hidden transition-all duration-500">
                                <span className="relative z-10">{t('usda.cta.btn')}</span>
